...
public class VideoGridViewAdapterNew extends BaseAdapter {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        RelativeLayout relativeLayout = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.video_item_new, parent, false);
        TextView textView = (TextView) relativeLayout.findViewById(R.id.tv_videoitem_title);//标题
